...
[Group options](../../../jsonforms-svelte/docs/renderers/layouts.md#group). General starts expanded; Schema, Appearance,
...
JSON). See [presentation renderer options](../../../jsonforms-svelte/docs/renderers/presentation.md). The
...
[Horizontal layout sizing](../../../jsonforms-svelte/docs/renderers/layouts.md#horizontallayout): per-placement
...
HorizontalLayout placement sizing uses `horizontalLayoutWidths` from the main `@chobantonov/jsonforms-svelte` entry point. Its flat canvas drag items use the same allocation as the runtime renderers. Direct children expose Layout → Columns (Auto or 2–16); Auto removes the option. Width follows the placement across moves; schema fields are unchanged. See the sibling [sizing contract](../../../jsonforms-svelte/docs/renderers/layouts.md#horizontallayout).
