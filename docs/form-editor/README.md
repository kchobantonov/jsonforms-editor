> This documentation belongs to the standalone sibling workspace **jsonforms-editor**. Package and app paths below are relative to that workspace. Renderer libraries and shared examples remain in **jsonforms-svelte**.
