import { inspectorBg } from "./inspector-bg.js";
...
const bg: Record<string, string> = {
  ...
  "Select an element to edit its properties.": "Изберете елемент, за да редактирате свойствата му.",
  General: "Общи",
  Schema: "Схема",
  Appearance: "Изглед",
  ...
  const value = {
    ...
    t(message: string) {
      ...
      return (
        ...
        (language === "bg" ? (inspectorBg[message] ?? bg[message]) : undefined) ??
        message
      );
    },
  };
