...
if (args.includes("--help")) {
  ...
  console.log(
    "Default: read-only comparison. --write updates generated component files in the editor component root; it requires --stage. Dependencies and CSS are reported, not installed.",
  );
  process.exit(0);
}
